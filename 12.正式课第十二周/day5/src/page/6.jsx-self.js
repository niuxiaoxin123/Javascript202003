        ...
        for(let key in this.props){
            if(key!=="children"){
                ...
                for(let i=0;i<this.props.children.length;i++){
                    ...
                    let  newCur = cur instanceof Element?cur.render():document.createTextNode(cur);
...
let objDOM ={
    render(ele,container){// ele: react元素 container: 承载的容器
...
//     <p b="1">zfpx</p>
// </div>
let box = obj.createElement("div",{a:100,c:235,className:"box"},"回龙观",obj.createElement('p',{b:1},"zfpx"));// 接收一下createElement的返回值；
